...
function affiliation_decitre_options_page_html() {
	...
	echo '<p>'.__('Short code usage example for product category link: <code>[affiliation_decitre_link product="9782908766684"]</code>','affiliation-decitre').'</p>';
	...
	echo '<table>';
	echo '<tr><td><label for="affiliation_decitre_campaign">'.__('Your Decitre affiliation campaign','affiliation-decitre').'</td><td><input name="affiliation_decitre_campaign" type="text" id="affiliation_decitre_campaign" value="'. get_option( 'affiliation_decitre_campaign' ) .'" /></label></td></tr>';
	echo '<tr><td><label for="affiliation_decitre_affiliate">'.__('Your Decitre affiliation ID (without #)','affiliation-decitre').'</td><td><input name="affiliation_decitre_affiliate" type="text" id="affiliation_decitre_affiliate" value="'. get_option( 'affiliation_decitre_affiliate' ) .'" /></label></td></tr>';
	echo '<tr><td><label for="affiliation_decitre_link_text">'.__('Your Decitre affiliation link default text','affiliation-decitre').'</td><td><input name="affiliation_decitre_link_text" type="text" id="affiliation_decitre_link_text" value="'. get_option( 'affiliation_decitre_link_text' ) .'" /></label></td></tr>';
	echo '<tr><td><label for="affiliation_decitre_button_text">'.__('Your Decitre affiliation button default text','affiliation-decitre').'</td><td><input name="affiliation_decitre_button_text" type="text" id="affiliation_decitre_button_text" value="'. get_option( 'affiliation_decitre_button_text' ) .'" /></label></td></tr>';
	echo '<tr><td><label for="affiliation_decitre_button_css">'.__('Your Decitre affiliation button CSS','affiliation-decitre').'</td><td><textarea name="affiliation_decitre_button_css" cols="80" id="affiliation_decitre_button_css">'. get_option( 'affiliation_decitre_button_css' ) .'</textarea></label></td></tr>';
...
function register_affiliation_decitre_settings() {
	register_setting( 'affiliation-decitre', 'affiliation_decitre_campaign' );
	register_setting( 'affiliation-decitre', 'affiliation_decitre_affiliate' );
	register_setting( 'affiliation-decitre', 'affiliation_decitre_button_css' );
	register_setting( 'affiliation-decitre', 'affiliation_decitre_button_text' );
	register_setting( 'affiliation-decitre', 'affiliation_decitre_link_text' );
